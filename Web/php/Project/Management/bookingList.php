...
$sql = "SELECT b.booking_id , f.facility_type, u.username, u.email, b.booking_date b.start_time, b.end_time, b.booked_time, bs.current_status
FROM booking b
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                if($row['current_status'] == 'Pending'){
                                    ...
                                    <form method='post' action='updateStatus.php' style='display:inline;'>
                                        <input type='hidden' name='booking_id' value='{$row['booking_id']}'>
                                        <button class='w3-button w3-red w3-small' name='action' value='reject'>Reject</button>
                                    </form>";
                                }else{
