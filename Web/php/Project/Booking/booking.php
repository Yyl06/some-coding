...
<html>
    ...
    <body class="w3-light-grey">
        <div class="w3-bar w3-light-grey w3-padding" style="position: fixed; top: 0; width: 100%; z-index: 999;">
        ...
        <div class="container w3-display-middle w3-card w3-white w3-padding-32 w3-round-large" style="width: 500px;">
            <h2 class="w3-center w3-text-blue">Book a Facility</h2>
            <form action="processBooking.php" method="post">
                <label class="w3-text-black"><b>Select Facility</b></label>
                ...
                <label class="w3-text-black"><b>Start Time</b></label>
                <input class="w3-input w3-border w3-round" type="time" name="start_time" required>
                <label class="w3-text-black"><b>End Time</b></label>
